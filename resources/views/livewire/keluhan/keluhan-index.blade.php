<div>
    ...
    <div class="text-sm breadcrumbs">
        <ul class="bg-[#3b82f6] px-4 py-2 rounded-t-lg w-max text-white">
            <li>
                <a href="/dashboard" class="text-white">Fayrooz > Keluhan</a>
            </li>
        </ul>
    </div>
                    ...
                    <tbody>
                        @forelse ($keluhan as $index => $k)
                            <tr class="hover:bg-[#f3eaff] transition-all" wire:key="user-{{ $k->id }}">
                                ...
                                <td class="py-2 px-4 border border-[#5e4a7e]">{{ $k->nama }}</td>
                                <td class="py-2 px-4 border border-[#5e4a7e]">{{ $k->layanan->nama }}</td>
                                <td class="py-2 px-4 border border-[#5e4a7e]">{{ $k->deskripsi ?? '-' }}</td>
                                <td class="py-2 px-4 border border-[#5e4a7e]">
