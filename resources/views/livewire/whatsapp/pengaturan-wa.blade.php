<div>
    ...
    <div class="text-sm breadcrumbs">
        <ul class="bg-[#3b82f6] px-4 py-2 rounded-t-lg w-max text-white">
            <li>
                <a href="/dashboard" class="text-white">Fayrooz > Pengaturan Wa API</a>
            </li>
        </ul>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg rounded-tl-none shadow border border-[#3b82f6]">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold text-[#5e4a7e]">Pengaturan Wa APU</h2>
                ...
                <table class="table w-full text-sm text-center border border-[#5e4a7e]">
                    <thead class="bg-[#3b82f6] bg-opacity-90 text-white">
                        <tr>
                            ...
                            <th class="py-3 px-4 border border-[#5e4a7e]">Token</th>
                        ...
                        @forelse ($waApi as $index => $w)
                            <tr class="hover:bg-[#f3eaff] transition-all" wire:key="user-{{ $w->id }}">
                                <td class="py-2 px-4 border border-[#5e4a7e]">
                                    {{ $loop->iteration }} </td>
                                <td class="py-2 px-4 border border-[#5e4a7e]">{{ $w->nama }}</td>
                                <td class="py-2 px-4 border border-[#5e4a7e]">{{ $w->base_url }}</td>
                                <td class="py-2 px-4 border border-[#5e4a7e]">{{ $w->token }}</td>
                                <td class="py-2 px-4 border border-[#5e4a7e]">
                                    @if ($w->active)
                                        <span
