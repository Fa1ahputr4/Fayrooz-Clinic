                    ...
                    <div x-show="tab === 'pemeriksaan'" x-cloak>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6 bg-white p-5 rounded-lg">
                                <!-- Jerawat Section -->
                                <div class="pt-4">
                                    <div class="flex flex-col" x-data="{ adaJerawat: false }" x-init="adaJerawat = $wire.jenisJerawat !== null && $wire.jenisJerawat !== ''">
                                        <label class="block text-sm font-medium text-gray-600 mb-2">Jerawat</label>
                                        <div class="flex items-center space-x-3">
                                            <button type="button"
                                                @click="adaJerawat = !adaJerawat; if (!adaJerawat) $wire.set('jenisJerawat', ''):"
