...
class Beautycare extends Component
{
    ...
    public $rekmedId;
    //pemeriksaan
    public $daftarKeluhan = [], $keluhanUtama = [], $alergi, $keteranganKeluhan, $warnaKulit, $jenisKulit, $teksturKulit, $kelembapanKulit, $jenisJerawat = [], $tingkatJerawat, $flek, $riwayatPenyakit, $produkTerakhir;
    //diagnosa
