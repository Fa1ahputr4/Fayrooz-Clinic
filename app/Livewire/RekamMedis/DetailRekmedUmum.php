...
class DetailRekmedUmum extends Component
{
    ...
    public function save()
    {
        ...
        try {
            ...
            return redirect()->route('rekmed-umum', ['id'=> $this->pasienId]);
        } catch (\Throwable $e) {
            DB::rollBack();
    ...
    public function getAssesmentProperty()
{
    ...
    {
        $this->rekmedId = RekmedUmum::with(['pendaftaran'])->findOrFail($id);
        ...
        $rekmed = RekmedUmum::where('id', $idrekmed)->with(['keluhanUtamaPasien', 'diagnosaTambahanPasien', 'resepPasien'])->first();
